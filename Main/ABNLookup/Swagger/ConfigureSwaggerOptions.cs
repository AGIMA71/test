...
{
    //This configuration is based of the ASP.NET Core configuration for ControllerBase services
    ...
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        public ConfigureSwaggerOptions(IApiVersionDescriptionProvider provider, IConfiguration configuration) =>
            (this.provider, appSettings) =
            (provider, configuration.GetSection(nameof(AppSettings)).Get<AppSettings>());
        ...
        OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description, ApiSettings apiSettings)
        {
            var info = new OpenApiInfo
            {
                ...
                Contact = apiSettings?.Contact != null
                    ? new OpenApiContact
                    {
                    ...
                    : null,
                License = apiSettings?.License != null
                    ? new OpenApiLicense
                    {
